...
#old:
    def ca_mer(self,status,map1,map2):
        t1,t2 = 0,0
        b1,b2 = 0,0
        l1,l2 = 0,0
        r1,r2 = 0,0
        ...
        if status == 1:
            if b1 == 1 and t2 ==1:#1b,2t
                if map1.edge[2].point == 1:
                    ...
                    if map1.edge[2].min_dir <= map2.edge[0].max_dir and map2.edge[0].max_dir <= map1.edge[2].max_dir:
        ...
        if status == 2:
            if r1 == 1 and l2 ==1:
                if map1.edge[3].point == 1:
                    ...
                    if map1.edge[3].min_dir <= map2.edge[1].max_dir and map2.edge[1].max_dir <= map1.edge[3].max_dir:
        ...
        if status == 3:
            if t1 == 1 and b2 ==1:
                if map1.edge[0].point == 1:
                    ...
                    if map1.edge[0].min_dir <= map2.edge[2].max_dir and map2.edge[2].max_dir <= map1.edge[0].max_dir:
...
#new:
    def can_mer(self,status,map1,map2):
        ...
        if status == 1:
            if b1 == 1 and t2 ==1:#1b,2t
                if map1.edge[2].point == 1:
                    for point in map2.edge[0].list:
                        if point == map1.edge[2].list[0]:
                            return True
                elif map2.edge[0].point == 1:
                    for point in map1.edge[2].list:
                        if point == map2.edge[0].list[0]:
                            return True
        ...
        if status == 2:
            if r1 == 1 and l2 ==1:
                if map1.edge[3].point == 1:
                    for point in map2.edge[1].list:
                        if point == map1.edge[3].list[0]:
                            return True
                    
                elif map2.edge[1].point == 1:
                    for point in map1.edge[3].list:
                        if point == map2.edge[1].list[0]:
                            return True
                else:
                    '''elif (map1.edge[3].min_dir< map2.edge[1].max_dir) or (map1.edge[3].max_dir > map2.edge[1].min_dir) :
                    ee_match = 1
        ...
        if status == 3:
            if t1 == 1 and b2 ==1:
                if map1.edge[0].point == 1:
                    for point in map2.edge[2].list:
                        if point == map1.edge[0].list[0]:
                            return True
                    
                elif map2.edge[2].point == 1:
                    for point in map1.edge[0].list:
                        if point == map2.edge[2].list[0]:
                            return True
        ...
        if status == 4:#check map1 and map4
            if l1 == 1 and r2 ==1:
                if map1.edge[1].point == 1:
                    for point in map2.edge[3].list:
                        if point == map1.edge[1].list[0]:
                            return True
    ...
    def poolmerge(self,i):
        ...
        label = str(i)
        name = './Multi_pin_routing_solver/amaster/128data/'+label + 'route_input.png'
        ...
        print(label)
name = './Multi_pin_routing_solver/amaster/secdata/'
start = 658
while True:
